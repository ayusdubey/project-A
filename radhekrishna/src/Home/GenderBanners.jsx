...
export default function GenderBanners({ onSelectGender, activeGender }) {
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
        ...
        <div
          ...
          className={`relative overflow-hidden rounded-2xl p-5 border transition-all duration-200 ${
            activeGender === 'men'
              ? 'ring-2 ring-blue-500 shadow-md bg-gradient-to-br from-blue-100 via-sky-50 to-white border-blue-300'
              : 'bg-gradient-to-br from-sky-50 via-blue-50/50 to-white hover:border-blue-300 border-slate-200 shadow-xs'
          }`}
        >
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="w-24 h-28 sm:w-28 sm:h-32 rounded-xl overflow-hidden flex-shrink-0 border-2 border-white shadow-md">
              <img
        ...
        <div
          ...
          className={`relative overflow-hidden rounded-2xl p-5 border transition-all duration-200 ${
            activeGender === 'women'
              ? 'ring-2 ring-pink-500 shadow-md bg-gradient-to-br from-pink-100 via-rose-50 to-white border-pink-300'
              : 'bg-gradient-to-br from-rose-50/70 via-pink-50/40 to-white hover:border-pink-300 border-slate-200 shadow-xs'
          }`}
        >
          <div className="flex items-center justify-between gap-4">
